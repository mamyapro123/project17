...
function draw() {
  ...
  if(gameState===PLAY){
   ...
   path.velocityX = -(6 + 2*distance/30);
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    text('press UP_ARROW to restart the game',300,190)
    path.velocityX = 0;
...
function pinkCyclists(){
        ...
        player1.scale =0.06;
        player1.velocityX = -(6 + 2*distance/30);
...
function yellowCyclists(){
        ...
        player2.scale =0.06;
        player2.velocityX = -(6 + 2*distance/30);
...
function redCyclists(){
        ...
        player3.scale =0.06;
        player3.velocityX = -(6 + 2*distance/30);
